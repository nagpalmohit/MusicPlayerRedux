                    ...
                    <View style={styles.searchContainer}>
                        <LinearGradient colors={[Colors.accentGradientStart, Colors.accentGradientEnd]}
                            ...
                            <View style={styles.songContainer}>
                                <Image source={{uri: this.props.currentSong.thumbnail}}
                                       style={styles.albumArt}/>
                                <View style={styles.infoContainer}>
                                    <Text style={styles.songTitle}>{this.props.currentSong.title}</Text>
                                    <Text
                                        style={styles.albumText}>{this.props.currentSong.album} - {this.props.currentSong.artist}</Text>
                                    <View style={styles.separator}/>
                                    <View style={styles.tagContainer}>
                                        <Text style={styles.tagText}>{this.props.currentSong.genre}</Text>
                                    </View>
                                </View>
                            </View>
                        </LinearGradient>
                        ...
                        <View style={styles.control}>
                            <Slider value={this.props.position}
                                    onValueChange={this.props.seek.bind(this)}
                                    minimumValue={0}
                            ...
                            <View style={styles.controlButtons}>
                                <TouchableOpacity>
                                    <AntDesign name={'heart'} color={(true) ? Colors.accentColor : Colors.headingColor}
                                               size={responsiveFontSize(3.5)}/>
                                </TouchableOpacity>
                                <TouchableOpacity onPress={this.props.previousSong.bind(this)}>
                                    <AntDesign name={'stepbackward'} color={Colors.headingColor}
                                               size={responsiveFontSize(3.5)}/>
                                </TouchableOpacity>

                                <TouchableOpacity style={styles.playContainer}
                                                  onPress={this.props.togglePause.bind(this)}>
                                    <MaterialIcons name={(this.props.isPaused ? 'play-arrow' : 'pause')}
                                                   color={Colors.headingColor}
                                                   size={responsiveFontSize(4)}/>
                                </TouchableOpacity>
                                <TouchableOpacity onPress={this.props.nextSong.bind(this)}>
